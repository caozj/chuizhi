...
(function ($) {
    ...
    //新增 删除byindex，并返回删除行的信息
    BootstrapTable.prototype.removeByIndex = function (id) {
        var len = this.options.data.length,
            row = this.getData()[id];
    ...
    var allowedMethods = [
        ...
        'insertRow', 'updateRow', 'updateCell', 'updateByUniqueId', 'removeByUniqueId','removeByIndex',
